...
server: common.o server_main.o server_handler.o server_handler_funcs.o 
	g++ -pthread -o serverex getip.o server_main.o server_handler.o handler_funcs.o && rm *.o
...
client: common.o client_main.o client_handler.o client_handler_funcs.o 
	g++ -pthread -o clientex getip.o client_main.o client_handler.o handler_funcs.o && rm *.o
